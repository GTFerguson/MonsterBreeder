...
public class Main extends JPanel implements ActionListener{
	...
	//These variables watch for button presses
	//Menu buttons
	private static boolean newGame = false, continueButton = false, settingsButton = false;
	//Main game screen buttons
	private static boolean fightButton = false, breedButton = false, endButton = false;
	//Fight screen buttons
	private static boolean attackButton = false, runButton = false;
	//Monster Card buttons
	private static boolean mchOne = false;
